...
// THIS FILE IS FOR NON WORKING CODE TO TEST ON
...
//             <Route exact path='/game' component={()=>{return <Game deck={this.state.deck} name={this.state.player}/>}}/>
//           </Switch>
//         </Router>
